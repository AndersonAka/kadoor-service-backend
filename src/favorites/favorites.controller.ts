...
export class FavoritesController {
  ...
  async getUserFavorites(
    ...
    return this.favoritesService.getUserFavorites(req.user.userId, type);
  }
  ...
  async addFavorite(
    ...
    return this.favoritesService.addFavorite(req.user.userId, body.vehicleId, body.apartmentId);
  }
  ...
  async removeFavorite(
    ...
    return this.favoritesService.removeFavorite(req.user.userId, body.vehicleId, body.apartmentId);
  }
  ...
  async toggleFavorite(
    ...
    return this.favoritesService.toggleFavorite(req.user.userId, body.vehicleId, body.apartmentId);
  }
  ...
  async checkFavorite(
    ...
    const isFavorite = await this.favoritesService.isFavorite(req.user.userId, vehicleId, apartmentId);
    return { isFavorite };
  }
}
